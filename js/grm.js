function grm () {
    ...
    $(".header").append(
        ...
        '<div class="in-right">' +
        '<ul class="util">' +
        '<li><button type="button" class="visual-toggle" title="테마 열기/닫기"><i class="icon icon-switch-white-off"><span class="blind">테마 열기/닫기</span></i></button><span class="blink-text">테마를 키면 더 밝아져요!!</span></li>' +
