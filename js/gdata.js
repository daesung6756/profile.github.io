...
var historyLog = [
    {
        ...
        support :'PC는 ie 9 이상, 기타 다른 브라우져 최신버전, Mobile은 375 Iphone 6/7/8.',
        description:'콘센트릭스에서는 기획자 없이 PMO, 디지이너, 퍼블리셔 3파트만 계약이 되었고, 스프링웍스 협력사에서 개발을 맡았다. ',
        feedback:'기획자가 없다보니 PMO파트에서 기획을 진행하였는데, 기획에 대한 전문지식 부족으로 단순 수정작업 이외에 UI개선 및 CMS툴의 관리를 생각한 컴퍼넌트 제작에서는 방향성을 제시 못하는 한계가 생겼다. 향후 해당 부분에 대해 지속적 문제재기를 하였고, 정식적으로 프로젝트에는 태깅되지는 않았지만, 여유가 되는 기획자분에게 종종 지원을 받아 진행하였다.',
    ...
    },
    {
        ...
        description:'브랜드 페이지 구축 후에 고객사의 불만족으로 한달도 되지않아 추가적인 계약으로 진행된 단기 프로젝트.',
        feedback:'부장급의 기획자와 외주 디지이너가 투입 되었다. 여러가지 인터렉션을 넣어 제안을 하였지만, 요청 했던 인터렉션을 다 구현할때 쯤 고객사의 변심으로 하나씩 제거하게 되면서, 결과적으로 페이드 인 정도의 인터렉션만 남게 되었다. 기획자와 외주디자이너가 한국 타이어 사이트의 기본 해상도를 인지 못하고 진행하여, 작업도중에 해상도를 바꾸는 해프닝도 생겼다.',
    ...
    },
    {
        ...
        type : '단기 제작 프로젝트',
        name:'한국타이어 한국 사이트 브랜드 페이지 제작',
        date:'2020.06 ~ 2020.06',
        agency:'Concentrix Korea',
        customer:'한국타이어',
        position: 'PL (PL 1명)',
        process:'한국 사이트 브랜드 페이지 제작',
        language:'Html, Css, jQuery',
        tool: 'Svn, eclipse, AEM',
        support :'PC는 ie 9 이상, 기타 다른 5대 브라우져 최신버전, Mobile은 375 Iphone 6/7/8.',
        description:'PMO 1명, 디자이너 1명, 퍼블리셔 1명 총 3명이 진행한 추가 계약 신규 페이지 제작 프로젝트이며, 총 제작 기간 대략 2~3주 정도로 잡혀 있었다.',
        feedback:'기획자의 부재로 역제안을 하지 못하고, 고객사의 의견에 이리저리 끌려다녀 WBS상의 일정을 준수 하지 못하였다. PM이 작업자들이 WBS를 준수할 수 있도록 일정 관리를 해줘야 하는데, PMO가 이일을 하기에는 무리가 있었던 듯 하다.',
        url:'https://www.hankooktire.com/kr/tires-product/ventus.html',
        rate  : 4
    },
    {
        ...
        description:'작업자가 기획자 PM 1명, 디자이너 1명, 퍼블리셔 1명이며, 마케팅기획 및 개발기획 두 파트 다 진행 된 운영 프로젝트이다.',
        feedback:'한국타이어 프로젝트 중 유일하게 기획자 PM, 디지이너, 퍼블리셔의 안정적인 조합으로 요청 작업 일정 준수, 작업자 피로도 누적 최저 등 안정적으로 운영 업무가 진행되었다. 한국타이어에서 인수한 자회사 에이젼시에 밀어주기 위해, 추가 적인 재계약은 무산 되었다. 그래도 업무가 종료 될 때 인수인계와 종료되고 나서도 업무 지원을 하여, 더 큰 인력 자원 손실 없이 깔끔하게 업무 종료를 하였다.',
